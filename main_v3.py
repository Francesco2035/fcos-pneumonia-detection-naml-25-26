...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=50,
        help=(
            "ResNet architecture depth: 50 or 101. "
            "Default: 50."
        ),
    )
...
def main():
    ...
    if args.resnet_depth not in (50, 101):
        raise ValueError(
            f"--resnet-depth must be 50 or 101, "
    ...
    if args.resume:
        ...
        if is_custom:
            ...
            print(
                ...
                f"Chest-Xray ResNet-{args.resnet_depth}."
            )
    ...
    # ---------------------------------------------------------
        ...
        if is_custom:
            ...
            print(
                ...
                f"ImageNet ResNet-{args.resnet_depth}."
            )
